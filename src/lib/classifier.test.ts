...
const CASES: Case[] = [
  ...
  { input: 'Langdock oder lokal', threadId: 'entscheidung', variantId: 'make-or-buy' },
  { input: 'cloud oder lokal', threadId: 'entscheidung', variantId: 'make-or-buy' },
  { input: 'Cloud On-Premise', threadId: 'entscheidung', variantId: 'make-or-buy' },
  { input: 'Langdock lokal', threadId: 'entscheidung', variantId: 'make-or-buy' },
  { input: 'SaaS / selbst hosten', threadId: 'entscheidung', variantId: 'make-or-buy' },
  ...
  { input: 'OpenAI oder Claude', threadId: 'entscheidung', variantId: 'anbieterauswahl' },
  { input: 'ChatGPT oder Claude', threadId: 'entscheidung', variantId: 'anbieterauswahl' },
  { input: 'OpenAI Claude', threadId: 'entscheidung', variantId: 'anbieterauswahl' },
  { input: 'Mistral vs Gemini', threadId: 'entscheidung', variantId: 'anbieterauswahl' },
  { input: 'CRM oder ERP', threadId: 'entscheidung' },
  ...
  { input: 'KI oder Automatisierung', threadId: 'ki-eignung' },
  ...
  { input: 'Pilot oder MVP', threadId: 'vergleich' },
  { input: 'Pilot MVP', threadId: 'vergleich' },
  { input: 'Agil klassisch', threadId: 'vergleich' },
