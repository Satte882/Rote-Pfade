    ...
    <section className="view" aria-labelledby="training-title">
      <div className="section-heading split-heading">
        <div>
          ...
          <p>Wähle den roten Faden, bevor die Lösung und die Begründung sichtbar werden.</p>
        </div>
      ...
      <div className="training-card">
        ...
        {revealed && (
          <div className={`training-feedback ${isCorrect ? 'correct-feedback' : 'wrong-feedback'}`} aria-live="polite">
            <strong>{isCorrect ? 'Richtig.' : `Passender ist: ${question.correctThread.name}.`}</strong>
            <p>{question.correctThread.description}</p>
            <div className="mini-thread">{question.correctThread.steps.join(' → ')}</div>
